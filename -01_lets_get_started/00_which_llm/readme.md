...
For a true test, I would throw a challenging prompt at them—like designing a multi-tool task (fetching, analyzing, and acting on data) with a long input history, JSON output, and API integration—and measure who delivers with minimal hassle, cost, context/output/API friction, and fastest response. What is your agent’s purpose?
